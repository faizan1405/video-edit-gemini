...
import { addEmojisToCaptions } from "./processors/caption-emoji.js";
...
export async function processJob(jobId) {
  ...
  try {
    ...
    if (captionMode !== CAPTION_MODE_NONE) {
      ...
      captionSegments = await addEmojisToCaptions(captionSegments, effectiveLanguage);
